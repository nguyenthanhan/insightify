    ...
    >
      ...
      <div className={cn('max-w-sm', isUser && 'max-w-xs')}>
        ...
        >
          ...
          {/* Chart response */}
          {message.type === 'chart' && message.data && 'chartType' in message.data && (
          ...
          {/* Table response */}
          {message.type === 'table' && message.data && 'rows' in message.data && (
            <div className="space-y-2">
              <p className="text-sm">{message.content}</p>
          ...
          {/* Insight card */}
          {message.type === 'insight' && message.data && 'description' in message.data && (
            <div className="space-y-2">
              <p className="text-sm">{message.content}</p>
